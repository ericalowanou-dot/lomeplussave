...
@section('page-title', 'Modifier une publicité')
...
<div class="admin-card">
    ...
    <div class="admin-card-body">
        <form method="POST" action="{{ route('admin.publicites.update', $publicite) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('titre') is-invalid @enderror" 
                               id="titre" name="titre" value="{{ old('titre', $publicite->titre) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted d-block mb-2">Laisser vide pour conserver l'image actuelle</small>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control @error('lien_url') is-invalid @enderror" 
                               id="lien_url" name="lien_url" value="{{ old('lien_url', $publicite->lien_url) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('position') is-invalid @enderror" 
                            ...
                            <option value="entre_articles" {{ old('position', $publicite->position) === 'entre_articles' ? 'selected' : '' }}>Entre les articles</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date_debut') is-invalid @enderror" 
                                       ...
                                       value="{{ old('date_debut', $publicite->date_debut ? $publicite->date_debut->format('Y-m-d') : '') }}">
                                @error('date_debut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date_fin') is-invalid @enderror" 
                                       ...
                                       value="{{ old('date_fin', $publicite->date_fin ? $publicite->date_fin->format('Y-m-d') : '') }}">
                                @error('date_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('ordre') is-invalid @enderror" 
                               id="ordre" name="ordre" value="{{ old('ordre', $publicite->ordre) }}" min="0">
                        @error('ordre')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  ...
                                  placeholder="Notes pour l'équipe...">{{ old('notes', $publicite->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                   {{ old('is_active', $publicite->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="card bg-light p-3 mb-3">
                        ...
                        <div class="mb-2">
                            <strong>Affichages:</strong> {{ number_format($publicite->affichages, 0, ',', ' ') }}
                        </div>
                        <div class="mb-2">
                            <strong>Clics:</strong> {{ number_format($publicite->clics, 0, ',', ' ') }}
                        </div>
                        @if($publicite->affichages > 0)
                            <div>
                                <strong>CTR:</strong> 
                                <span class="text-success">
                                    {{ number_format(($publicite->clics / $publicite->affichages) * 100, 2) }}%
                                </span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="card bg-info text-white p-3">
                        <h6 class="card-title">État actuel</h6>
                        <div>
...
<div id="loadingOverlay" style="display:none;">
    <div class="loading-content">
        ...
        <p class="text-white">Mise à jour de la publicité en cours...</p>
    </div>
</div>
