...
class MessageController extends Controller
{
    ...
    public function adminCompose(Request $request)
    {
        ...
        if ($request->has('message')) {
            $parentMessage = Message::findOrFail($request->message);
        }
        
        return view('admin.messages.compose', ['message' => $parentMessage]);
    }
    ...
    public function adminSend(Request $request)
    {
        ...
        // Gérer le message parent si c'est une réponse
        ...
        $message = Message::create([
            ...
            'subject' => $request->subject ?: ($parentMessageId ? 'Re: ' . ($parentMessage->subject ?: 'Sans sujet') : null),
            'body' => $request->body,
