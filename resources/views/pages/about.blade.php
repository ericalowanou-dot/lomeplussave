...
<div class="about-page-container">
    ...
    <div class="about-hero">
        <div class="container">
            <h1 class="about-hero-title">À propos de <span class="orange-text">Lome+</span></h1>
...
<style>
    ...
    .about-hero-title span.orange-text {
        color: #f4751a;
    }
    ...
    .contact-value a:hover {
        ...
        color: #d96614 !important;
    }
    
    .contact-item .contact-value:not(a) {
        color: #f4751a !important;
        font-weight: 600;
    }
