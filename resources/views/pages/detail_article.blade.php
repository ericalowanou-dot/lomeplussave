...
@endif
    ...
    <style>
        ...
        @media (min-width: 992px) {
            ...
            .detail-container {
                /* max-width : content-width.css (aligné barre orange) */
...
@endif
        ...
        <section id="articles-similaires">
            ...
            @else
                {{-- Même partial que l'accueil (cartes + écarts identiques) --}}
                <div class="container">
                    @include('partials.articles-list', ['articles' => $articlesParCategorie])
                </div>
            @endif
