                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('position') is-invalid @enderror" 
                            ...
                            <option value="entre_articles" {{ old('position') === 'entre_articles' ? 'selected' : '' }}>Entre les articles (slot précis)</option>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card bg-light p-3">
                        ...
                        <small class="text-muted">
                            ...
                            <strong>Entre articles:</strong> Slot individuel après le N-ème article (ex. après 2, 5 ou 9)<br>
